...
/*ChatClient connects to ChatServer and prints all the messages
* received from the server. It also allows the user to send messages to the
* server. ChatClient thread reads messages and print them to the standard
...
public class ChatClient
{
	...
	//public static final int SERVER_PORT = 1976;

	public static Integer SERVER_PORT=ChatServer.LISTENING_PORT;
